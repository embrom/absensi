...
class GuruTile extends StatefulWidget {
  final List<QueryDocumentSnapshot<Map<String, dynamic>>> data;
  final int i;
  final List<String> listHadir;
  final Map<String, dynamic> mapData;
  GuruTile(this.data, this.i, this.listHadir, this.mapData);

  @override
  _GuruTileState createState() => _GuruTileState();
}

class _GuruTileState extends State<GuruTile> {
  bool pressed = false;
  String? days(int asw) {
                  ...
                  (widget.data[widget.i].data()['Day'] as List).every(
                      ...
                      : () async {
                          ...
                          await FirebaseFirestore.instance
                              ...
                              .update({
                            'Pertemuan': widget.mapData['Pertemuan'] - 1,
                            'Fee': widget.mapData['Fee'] +
                                widget.data[widget.i].data()['Fee'],
